...
All screenshots were taken against the live Vercel deployment and live in `docs/screenshots/`. Each one is embedded in the section it proves; this table is the index.
